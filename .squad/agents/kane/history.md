...
- Radial's CLI command (RadialCmd) now orchestrates 18-stage pipeline.Run() call instead of inline Run() logic.
- Pipeline pattern is now standard; future viz CLI commands should follow this architecture.
